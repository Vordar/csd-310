-- Assuming Database has not been created previously
-- Copy and paste the below code into MySQL, long_whatabook database will be created
-- Otherwise, start with line 10 to clear and clean populate the database
...
-- populate store
INSERT INTO store_fields(store_id, locale) VALUES ('001', '123 A St Omaha, NE 68123');
